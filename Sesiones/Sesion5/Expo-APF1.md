...
### 5.3 Cronograma de hitos estratégicos (Diagrama de Gantt)
Planificación temporal semestral articulada en 4 hitos evaluativos (Semanas 1 a 18):

```mermaid
gantt
    title Cronograma de Hitos Estratégicos RescueLink (Semanas 1 a 18)
